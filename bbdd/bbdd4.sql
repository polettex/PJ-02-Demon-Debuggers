...
-- Tabla de recursos (con columnas de posición para mesas arrastrables)
CREATE TABLE recursos (
    id_recurso INT AUTO_INCREMENT PRIMARY KEY,
    tipo ENUM('sala','mesa') NOT NULL,
...
-- Las posiciones x,y por defecto son 50.00 (centro)
...
-- Reserva de ejemplo
INSERT INTO reservas (id_usuario, id_recurso, nombre_cliente, personas, fecha, hora_inicio, hora_final) VALUES
(1, 10, 'Cliente Ejemplo', 2, '2025-12-05', '20:00:00', '22:00:00');

-- =========================================
-- NOTAS SOBRE CAMBIOS EN BBDD4
-- =========================================
-- 1. Eliminado tipo 'silla' del ENUM de recursos (solo 'sala' y 'mesa')
-- 2. Agregadas columnas posicion_x y posicion_y para mesas arrastrables
-- 3. Las posiciones son porcentajes (0-100) relativos al contenedor
-- 4. Por defecto las mesas aparecen en el centro (50.00, 50.00)
-- 5. Agregadas columnas nombre_cliente y personas a la tabla reservas para reservas anticipadas
